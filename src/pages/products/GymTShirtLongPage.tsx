...
const GymTShirtLongPage: React.FC = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/long-sleeve-tshirt-gym-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">LONG SLEEVE GYM T-SHIRT</h1>
            <p className="text-xl text-rb-gray-300">Extended coverage gym t-shirt designed for training and workouts</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-rb-gray-900">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <img
                src="/long-sleeve-tshirt-gym-frontback.png"
                alt="Long Sleeve Gym T-Shirt"
...
export default GymTShirtLongPage;