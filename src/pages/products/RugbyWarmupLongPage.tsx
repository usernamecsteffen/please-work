...
const RugbyWarmupLongPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/long-sleeve-warm-up-frontback.png', alt: 'Rugby Long Sleeve Warm-Up Front and Back View' },
    { src: '/long-sleeve-warm-up-design-guide.png', alt: 'Rugby Long Sleeve Warm-Up Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/long-sleeve-warm-up-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">RUGBY LONG SLEEVE WARM-UP</h1>
            <p className="text-xl text-rb-gray-300">Extended coverage warm-up gear for cooler conditions and extended training</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                title: 'Rugby Short Sleeve Warm-Up',
...
export default RugbyWarmupLongPage;