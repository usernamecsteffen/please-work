...
const HockeyShirtPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/hockey-shirt-frontback.png', alt: 'Hockey Shirt Front and Back View' },
    { src: '/hockey-shirt-design-guide.png', alt: 'Hockey Shirt Design Guide' },
    { src: '/hockey-shirt-design-guide-back.png', alt: 'Hockey Shirt Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/hockey-shirt-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">HOCKEY SHIRT</h1>
            <p className="text-xl text-rb-gray-300">High-performance hockey shirts built for speed and precision</p>
          </motion.div>
        </div>
      </section>
...
export default HockeyShirtPage;