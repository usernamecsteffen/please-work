    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/leg-sleeves.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">LEG SLEEVES</h1>
            <p className="text-xl text-rb-gray-300">Performance leg sleeves designed for athletic support and protection</p>
          </motion.div>
        </div>
      </section>
                  ...
                  <table className="w-full text-rb-gray-300">
                    <tbody className="space-y-2">
                      ...
                      <tr>
                        ...
                        <td className="py-2">Above Ankle (45–47 cm)</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
