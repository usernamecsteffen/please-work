...
const HuntingHoodiePage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/hunting-hoodie-frontback.png', alt: 'Hunting Hoodie Front and Back View' },
    { src: '/hunting-hoodie-design-guide.png', alt: 'Hunting Hoodie Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/hunting-hoodie-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">HUNTING HOODIE</h1>
            <p className="text-xl text-rb-gray-300">Premium hunting hoodie designed for comfort and stealth in the field</p>
          </motion.div>
        </div>
      </section>
...
export default HuntingHoodiePage;