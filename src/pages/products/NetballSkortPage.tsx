...
const NetballSkortPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/skort-frontback.png', alt: 'Netball Skort Front and Back View' },
    { src: '/skort-design-guide.png', alt: 'Netball Skort Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/skort-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">NETBALL SKORT</h1>
            <p className="text-xl text-rb-gray-300">Perfect combination of style and functionality for netball performance</p>
          </motion.div>
        </div>
      </section>
...
export default NetballSkortPage;