...
const HuntingPufferShortPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/hunting-puffer-short-frontback.png', alt: 'Hunting Puffer Short Front and Back View' },
    { src: '/hunting-puffer-short-design-guide.png', alt: 'Hunting Puffer Short Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/hunting-puffer-short-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">HUNTING PUFFER SHORT</h1>
            <p className="text-xl text-rb-gray-300">Compact hunting puffer jacket for mobility and warmth</p>
          </motion.div>
        </div>
      </section>
...
export default HuntingPufferShortPage;