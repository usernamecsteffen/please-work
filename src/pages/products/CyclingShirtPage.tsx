...
const CyclingShirtPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/cycling-shirt-frontback.png', alt: 'Cycling Shirt Front and Back View' },
    { src: '/cycling-shirt-design-guide.png', alt: 'Cycling Shirt Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/cycling-shirt-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">CYCLING SHIRT</h1>
            <p className="text-xl text-rb-gray-300">Performance cycling shirt designed for aerodynamics and comfort</p>
          </motion.div>
        </div>
      </section>
...
export default CyclingShirtPage;