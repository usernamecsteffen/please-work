...
const CricketPantsPage: React.FC = () => {
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/cricket-pants-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">CRICKET PANTS</h1>
            <p className="text-xl text-rb-gray-300">Classic cricket whites designed for comfort and tradition</p>
          </motion.div>
        </div>
      </section>
...
export default CricketPantsPage;