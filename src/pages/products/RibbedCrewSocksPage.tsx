...
const RibbedCrewSocksPage: React.FC = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/ribbed-crew-socks.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">RIBBED CREW SOCKS</h1>
            <p className="text-xl text-rb-gray-300">Classic ribbed crew socks with relaxed compression for all-day comfort</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-rb-gray-900">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <img
                src="/ribbed-crew-socks.png"
                alt="Ribbed Crew Socks"
                  ...
                  <table className="w-full text-rb-gray-300">
                    <tbody className="space-y-2">
                      ...
                      <tr>
                        ...
                        <td className="py-2">Under Calf (14–18 cm)</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
...
export default RibbedCrewSocksPage;