...
const FishingTeeShortPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/fishing-tee-short-frontback.png', alt: 'Fishing Tee Short Sleeve Front and Back View' },
    { src: '/fishing-tee-short-design-guide.png', alt: 'Fishing Tee Short Sleeve Design Guide' },
    { src: '/fishing-tee-short-design-guide-back.png', alt: 'Fishing Tee Short Sleeve Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/fishing-tee-short-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">FISHING TEE SHORT SLEEVE</h1>
            <p className="text-xl text-rb-gray-300">Lightweight fishing tee designed for comfort and performance on the water</p>
          </motion.div>
        </div>
      </section>
...
export default FishingTeeShortPage;