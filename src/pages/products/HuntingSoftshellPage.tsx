...
const HuntingSoftshellPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/hunting-softshell-frontback.png', alt: 'Hunting Softshell Jacket Front and Back View' },
    { src: '/hunting-softshell-design-guide.png', alt: 'Hunting Softshell Jacket Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/hunting-softshell-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">HUNTING SOFTSHELL JACKET</h1>
            <p className="text-xl text-rb-gray-300">Weather-resistant softshell jacket designed for hunting performance</p>
          </motion.div>
        </div>
      </section>
...
export default HuntingSoftshellPage;