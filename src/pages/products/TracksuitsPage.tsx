...
const TracksuitsPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/tracksuits-frontback.png', alt: 'Tracksuits Front and Back View' },
    { src: '/tracksuits-design-guide.png', alt: 'Tracksuits Design Guide' },
    { src: '/tracksuits-design-guide-back.png', alt: 'Tracksuits Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/tracksuits-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">TRACKSUITS</h1>
            <p className="text-xl text-rb-gray-300">Premium tracksuit sets designed for training and team unity</p>
          </motion.div>
        </div>
      </section>
