...
const FishingHoodiePage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/fishing-hoodie-frontback.png', alt: 'Fishing Hoodie Front and Back View' },
    { src: '/fishing-hoodie-design-guide.png', alt: 'Fishing Hoodie Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/fishing-hoodie-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">FISHING HOODIE</h1>
            <p className="text-xl text-rb-gray-300">Premium fishing hoodie designed for comfort and performance on the water</p>
          </motion.div>
        </div>
      </section>
...
export default FishingHoodiePage;