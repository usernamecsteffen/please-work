...
const GolfDressPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/golf-dress-frontback.png', alt: 'Golf Dress Front and Back View' },
    { src: '/golf-dress-design-guide.png', alt: 'Golf Dress Design Guide' },
    { src: '/golf-dress-design-guide-back.png', alt: 'Golf Dress Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/golf-dress-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">GOLF DRESS</h1>
            <p className="text-xl text-rb-gray-300">Elegant golf dress designed for style and performance on the course</p>
          </motion.div>
        </div>
      </section>
