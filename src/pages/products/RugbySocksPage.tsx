    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/rugby-socks.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">RUGBY SOCKS</h1>
            <p className="text-xl text-rb-gray-300">Designed for durability, comfort, and peak on-field performance</p>
          </motion.div>
        </div>
      </section>
