...
const GolfZipTopPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/golf-zip-top-frontback.png', alt: 'Golf Zip Top Front and Back View' },
    { src: '/golf-zip-top-design-guide.png', alt: 'Golf Zip Top Design Guide' },
    { src: '/golf-zip-top-design-guide-back.png', alt: 'Golf Zip Top Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/golf-zip-top-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">GOLF ZIP TOP</h1>
            <p className="text-xl text-rb-gray-300">Versatile golf zip top designed for style and performance on the course</p>
          </motion.div>
        </div>
      </section>
