...
const NetballDressPage: React.FC = () => {
  ...
  const images = [
    { src: '/netball-dress-frontback.png', alt: 'Netball Dress Front and Back View' },
    { src: '/netball-dress-design-guide.png', alt: 'Netball Dress Design Guide' },
    { src: '/netball-dress-design-guide-back.png', alt: 'Netball Dress Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/netball-dress-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">NETBALL DRESS</h1>
            <p className="text-xl text-rb-gray-300">Engineered for agility and performance on the netball court</p>
          </motion.div>
        </div>
      </section>
