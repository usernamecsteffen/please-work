...
const NetballHotPantsPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/hot-pants-frontback.png', alt: 'Netball Hot Pants Front and Back View' },
    { src: '/hot-pants-design-guide.png', alt: 'Netball Hot Pants Design Guide' },
    { src: '/hot-pants-design-guide-back.png', alt: 'Netball Hot Pants Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/hot-pants-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">NETBALL HOT PANTS</h1>
...
export default NetballHotPantsPage;