...
const HuntingZipTopPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/hunting-zip-top-frontback.png', alt: 'Hunting Zip Top Front and Back View' },
    { src: '/hunting-zip-top-design-guide.png', alt: 'Hunting Zip Top Design Guide' },
    { src: '/hunting-zip-top-design-guide-back.png', alt: 'Hunting Zip Top Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/hunting-zip-top-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">HUNTING ZIP TOP</h1>
            <p className="text-xl text-rb-gray-300">Versatile hunting zip top designed for layering and performance</p>
          </motion.div>
        </div>
      </section>
...
export default HuntingZipTopPage;