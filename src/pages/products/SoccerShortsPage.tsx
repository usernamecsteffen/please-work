...
const SoccerShortsPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/soccer-shorts-frontback.png', alt: 'Soccer Shorts Front and Back View' },
    { src: '/soccer-shorts-design-guide.png', alt: 'Soccer Shorts Design Guide' },
    { src: '/soccer-shorts-design-guide-back.png', alt: 'Soccer Shorts Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/soccer-shorts-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">SOCCER SHORTS</h1>
            <p className="text-xl text-rb-gray-300">Lightweight soccer shorts engineered for speed and agility</p>
          </motion.div>
        </div>
      </section>
...
export default SoccerShortsPage;