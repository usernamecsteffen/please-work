...
const HockeyDressPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/hockey-dress-frontback.png', alt: 'Hockey Dress Front and Back View' },
    { src: '/hockey-dress-design-guide.png', alt: 'Hockey Dress Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/hockey-dress-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">HOCKEY DRESS</h1>
            <p className="text-xl text-rb-gray-300">Professional hockey dress designed for speed and agility on the field</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: 'Hockey Shirt',
                image: '/hockey-shirt-frontback.png',
...
export default HockeyDressPage;