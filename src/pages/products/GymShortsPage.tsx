    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/gym-shorts-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">GYM SHORTS</h1>
            <p className="text-xl text-rb-gray-300">Performance shorts designed for intense training and workouts</p>
          </motion.div>
        </div>
      </section>
