...
const PremiumCrewSocksPage: React.FC = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/premium-crew-socks.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">PREMIUM CREW SOCKS</h1>
            <p className="text-xl text-rb-gray-300">High-quality crew socks with slight compression for enhanced performance</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-rb-gray-900">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <img
                src="/premium-crew-socks.png"
                alt="Premium Crew Socks"
                  ...
                  <table className="w-full text-rb-gray-300">
                    <tbody className="space-y-2">
                      ...
                      <tr className="border-b border-rb-gray-700">
                        ...
                        <td className="py-2">X-Small - X-Large</td>
                      </tr>
                      <tr className="border-b border-rb-gray-700">
                      ...
                      <tr>
                        ...
                        <td className="py-2">Under Calf (12–18 cm)</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
...
export default PremiumCrewSocksPage;