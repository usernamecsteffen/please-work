...
const HuntingPufferLongPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/hunting-puffer-long-frontback.png', alt: 'Hunting Puffer Long Front and Back View' },
    { src: '/hunting-puffer-long-design-guide.png', alt: 'Hunting Puffer Long Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/hunting-puffer-long-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">HUNTING PUFFER LONG</h1>
            <p className="text-xl text-rb-gray-300">Extended coverage hunting puffer jacket for extreme weather conditions</p>
          </motion.div>
        </div>
      </section>
...
export default HuntingPufferLongPage;