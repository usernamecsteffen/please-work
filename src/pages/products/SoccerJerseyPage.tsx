...
const SoccerJerseyPage: React.FC = () => {
  ...
  const images = [
    ...
    { src: '/soccer-jersey-design-guide-back.png', alt: 'Soccer Jersey Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/soccer-jersey-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">SOCCER JERSEY</h1>
            <p className="text-xl text-rb-gray-300">Precision-engineered for the beautiful game - built for speed and skill</p>
          </motion.div>
        </div>
      </section>
...
export default SoccerJerseyPage;