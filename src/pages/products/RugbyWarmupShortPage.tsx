...
const RugbyWarmupShortPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/short-sleeve-warm-up-frontback.png', alt: 'Rugby Short Sleeve Warm-Up Front and Back View' },
    { src: '/short-sleeve-warm-up-design-guide.png', alt: 'Rugby Short Sleeve Warm-Up Design Guide' },
    { src: '/short-sleeve-warm-up-design-guide-back.png', alt: 'Rugby Short Sleeve Warm-Up Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/short-sleeve-warm-up-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">RUGBY SHORT SLEEVE WARM-UP</h1>
            <p className="text-xl text-rb-gray-300">Professional warm-up gear designed for pre-game preparation and training</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                title: 'Rugby Long Sleeve Warm-Up',
...
export default RugbyWarmupShortPage;