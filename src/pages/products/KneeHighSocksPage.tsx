...
const KneeHighSocksPage: React.FC = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/knee-high-socks.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">KNEE HIGH SOCKS</h1>
            <p className="text-xl text-rb-gray-300">Extended coverage knee high socks with slight compression</p>
          </motion.div>
        </div>
      </section>
                  ...
                  <table className="w-full text-rb-gray-300">
                    <tbody className="space-y-2">
                      ...
                      <tr className="border-b border-rb-gray-700">
                        ...
                        <td className="py-2">Small - Large</td>
                      </tr>
                      <tr className="border-b border-rb-gray-700">
...
export default KneeHighSocksPage;