...
const HockeyShortsPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/hockey-shorts-frontback.png', alt: 'Hockey Shorts Front and Back View' },
    { src: '/hockey-shorts-design-guide.png', alt: 'Hockey Shorts Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/hockey-shorts-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">HOCKEY SHORTS</h1>
            <p className="text-xl text-rb-gray-300">High-performance hockey shorts designed for speed and agility</p>
          </motion.div>
        </div>
      </section>
...
export default HockeyShortsPage;