    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/backpack-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">BACKPACK</h1>
            <p className="text-xl text-rb-gray-300">High-capacity backpack designed for schoolwear, sports teams, and staff gear</p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <ul className="space-y-2 text-rb-gray-300">
                  <li>• High-capacity backpack with reinforced zippers</li>
                  <li>• Water-resistant outer shell with padded laptop compartment</li>
                  <li>• Adjustable padded shoulder straps for all-day comfort</li>
                  <li>• Ideal for schoolwear, sports teams, or staff gear</li>
                  <li>• Custom branding available on front panel</li>
                </ul>
              </motion.div>
