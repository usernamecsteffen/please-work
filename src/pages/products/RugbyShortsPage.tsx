...
const RugbyShortsPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/rugby-shorts-frontback.png', alt: 'Rugby Shorts Front and Back View' },
    { src: '/rugby-shorts-design-guide.png', alt: 'Rugby Shorts Design Guide' },
    { src: '/rugby-shorts-design-guide-back.png', alt: 'Rugby Shorts Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/rugby-shorts-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">RUGBY SHORTS</h1>
            <p className="text-xl text-rb-gray-300">Built tough for the scrum - engineered for maximum mobility and durability</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                title: 'Rugby Warm-Up Long Sleeve',
                image: '/rugby-warmup-long.png',
...
export default RugbyShortsPage;