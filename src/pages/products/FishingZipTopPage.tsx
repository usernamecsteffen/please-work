...
const FishingZipTopPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/fishing-zip-top-frontback.png', alt: 'Fishing Zip Top Front and Back View' },
    { src: '/fishing-zip-top-design-guide.png', alt: 'Fishing Zip Top Design Guide' },
    { src: '/fishing-zip-top-design-guide-back.png', alt: 'Fishing Zip Top Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/fishing-zip-top-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">FISHING ZIP TOP</h1>
            <p className="text-xl text-rb-gray-300">Versatile fishing zip top designed for comfort and performance on the water</p>
          </motion.div>
        </div>
      </section>
...
export default FishingZipTopPage;