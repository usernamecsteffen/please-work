...
const FishingTeeLongPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/fishing-tee-long-frontback.png', alt: 'Fishing Tee Long Sleeve Front and Back View' },
    { src: '/fishing-tee-long-design-guide.png', alt: 'Fishing Tee Long Sleeve Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/fishing-tee-long-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">FISHING TEE LONG SLEEVE</h1>
            <p className="text-xl text-rb-gray-300">Extended coverage fishing tee designed for all-day comfort on the water</p>
          </motion.div>
        </div>
      </section>
...
export default FishingTeeLongPage;