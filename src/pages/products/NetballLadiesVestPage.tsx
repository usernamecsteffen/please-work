...
const NetballLadiesVestPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/ladies-vest-frontback.png', alt: 'Netball Ladies Vest Front and Back View' },
    { src: '/ladies-vest-design-guide.png', alt: 'Netball Ladies Vest Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/ladies-vest-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">NETBALL LADIES VEST</h1>
            <p className="text-xl text-rb-gray-300">Designed specifically for female athletes with comfort and performance in mind</p>
          </motion.div>
        </div>
      </section>
...
export default NetballLadiesVestPage;