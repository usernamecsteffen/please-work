...
const PromoCrewSocksPage: React.FC = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/promo-crew-socks.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">PROMO CREW SOCKS</h1>
            <p className="text-xl text-rb-gray-300">Promotional crew socks perfect for events and giveaways</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-rb-gray-900">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <img
                src="/promo-crew-socks.png"
                alt="Promo Crew Socks"
                  ...
                  <table className="w-full text-rb-gray-300">
                    <tbody className="space-y-2">
                      ...
                      <tr className="border-b border-rb-gray-700">
                        ...
                        <td className="py-2">Flat Seam</td>
                      </tr>
                      <tr className="border-b border-rb-gray-700">
                        <td className="py-2 font-semibold">Sizes</td>
                        <td className="py-2">One Size</td>
                      </tr>
                      <tr className="border-b border-rb-gray-700">
                      ...
                      <tr>
                        ...
                        <td className="py-2">Under Calf</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
...
export default PromoCrewSocksPage;