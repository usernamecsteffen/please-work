...
const NetballShortsPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/netball-shorts-frontback.png', alt: 'Netball Shorts Front and Back View' },
    { src: '/netball-shorts-design-guide.png', alt: 'Netball Shorts Design Guide' },
    { src: '/netball-shorts-design-guide-back.png', alt: 'Netball Shorts Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/netball-shorts-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">NETBALL SHORTS</h1>
            <p className="text-xl text-rb-gray-300">Designed for agility and comfort on the netball court</p>
          </motion.div>
        </div>
      </section>
...
export default NetballShortsPage;